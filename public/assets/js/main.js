...
/*! License details at fancyapps.com/license */
let fancybox_hash_e,fancybox_hash_n,fancybox_hash_o=!1,fancybox_hash_r=!1,fancybox_hash_i=!1,fancybox_hash_l=!1;const fancybox_hash_s=()=>{const t=new URL(document.URL).hash,e=t.slice(1).split("-"),n=e[e.length-1],o=n&&/^\+?\d+$/.test(n)&&parseInt(e.pop()||"1",10)||1;return{urlHash:t,urlSlug:e.join("-"),urlIndex:o}},fancybox_hash_a=()=>{const t=null==fancybox_hash_e?void 0:fancybox_hash_e.getInstance();return!(!t||1!=t.getState())},fancybox_hash_u=()=>{if(!fancybox_hash_e)return;if(fancybox_hash_a())return;const{urlSlug:t,urlIndex:n}=fancybox_hash_s();if(!t)return;let o=document.querySelector(`[data-slug="${t}"]`);o&&fancybox_hash_e.fromTriggerEl(o),fancybox_hash_a()||(o=document.querySelectorAll(`[data-fancybox="${t}"]`)[n-1],o&&fancybox_hash_e.fromTriggerEl(o,{startIndex:n-1})),fancybox_hash_a()&&o&&!o.closest("[inert]")&&o.scrollIntoView({behavior:"instant",block:"center",inline:"center"})},fancybox_hash_c=()=>{if(!fancybox_hash_e)return;if(fancybox_hash_i)return;const t=null==fancybox_hash_e?void 0:fancybox_hash_e.getInstance(),n=null==t?void 0:t.getCarousel();if(!1===(null==t?void 0:t.getOptions().Hash))return;const{urlSlug:o,urlIndex:a}=fancybox_hash_s();if(t&&n){const e=n.getSlides();for(const t of e||[])if(o===t.slug||o===t.fancybox&&t.index===a-1)return fancybox_hash_r=!1,void n.goTo(t.index);fancybox_hash_l=!0,t.close(),fancybox_hash_l=!1}fancybox_hash_u()},fancybox_hash_d=()=>{fancybox_hash_e&&(fancybox_hash_n=setTimeout((()=>{fancybox_hash_o=!0,fancybox_hash_u(),fancybox_hash_o=!1}),300),window.addEventListener("hashchange",fancybox_hash_c,!1))},fancybox_hash_f=()=>{let t,e="auto",a="";function u(){var n,i,l;if(!t||!t.isTopMost())return;if(!1===t.getOptions().Hash)return;if(fancybox_hash_o){const e=t.getOptions().sync;e&&e.goTo((null===(n=null==t?void 0:t.getCarousel())||void 0===n?void 0:n.getPageIndex())||0,{transition:!1,tween:!1})}const u=t.getCarousel();if(!u)return;const{urlHash:d,urlSlug:f}=fancybox_hash_s(),g=t.getSlide();if(!g)return;let h=g.slug||g.fancybox||"",w=parseInt(g.index+"",10)+1;if(!h)return;let p=g.slug?`#${g.slug}`:`#${h}-${w}`;((null===(l=null===(i=t.getCarousel())||void 0===i?void 0:i.getPages())||void 0===l?void 0:l.length)||0)<2&&(p=`#${h}`),d!==p&&(a=d),history.scrollRestoration&&(e=history.scrollRestoration,history.scrollRestoration="manual"),u.on("change",c);const y=h!==f;try{window.history[y?"pushState":"replaceState"]({},document.title,window.location.pathname+window.location.search+p),y&&(fancybox_hash_r=!0)}catch(t){}}function c(){if(!t||!t.isTopMost())return;if(!1===t.getOptions().Hash)return;const e=t.getSlide();if(!e)return;let n=e.slug||e.fancybox||"",o=e.index+1,r=e.slug?`#${e.slug}`:`#${n}-${o}`;fancybox_hash_i=!0;try{window.history.replaceState({},document.title,window.location.pathname+window.location.search+r)}catch(t){}fancybox_hash_i=!1}function d(){if(fancybox_hash_l)return;if(!t||!t.isTopMost())return;if(!1===t.getOptions().Hash)return;const e=t.getSlide();if(!e)return;if(e.fancybox||""){fancybox_hash_i=!0;try{fancybox_hash_r&&!function(){if(window.parent===window)return!1;try{var t=window.frameElement}catch(e){t=null}return null===t?"data:"===location.protocol:t.hasAttribute("sandbox")}()?window.history.back():window.history.replaceState({},document.title,window.location.pathname+window.location.search+a)}catch(t){}fancybox_hash_i=!1}}return{init:function(e){clearTimeout(fancybox_hash_n),t=e,t.on("ready",u),t.on("close",d)},destroy:function(){null==t||t.off("ready",u),null==t||t.off("close",d);const n=null==t?void 0:t.getCarousel();n&&n.off("change",c),t=void 0,history.scrollRestoration&&e&&(history.scrollRestoration=e)}}};fancybox_hash_f.startFromUrl=fancybox_hash_u,fancybox_hash_f.setup=function(n){fancybox_hash_e||(fancybox_hash_e=n,canUseDOM_e()&&(/complete|interactive|loaded/.test(document.readyState)?fancybox_hash_d():document.addEventListener("DOMContentLoaded",fancybox_hash_d)))};
